...
public:
    ...
    scml2::initiator_socket<64> noc_n_initiator;        // To external NOC-N (outbound)
    scml2::initiator_socket<64> tlb_app_outbound_port;  // To TLB App Outbound
    scml2::initiator_socket<32> msi_relay_port;         // To MSI Relay
