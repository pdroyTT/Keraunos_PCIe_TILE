...
public:
    ...
    tlm_utils::simple_initiator_socket<TLBSysOut0, 64> translated_socket;
...
public:
    ...
    // TLM initiator socket for translated traffic (AXI4)
    tlm_utils::simple_initiator_socket<TLBAppOut0, 64> translated_socket;
...
public:
    ...
    // TLM initiator socket for translated traffic (AXI4)
    tlm_utils::simple_initiator_socket<TLBAppOut1, 64> translated_socket;
