...
public:
    ...
    tlm_utils::simple_initiator_socket<TLBSysIn0, 64> translated_socket;
...
public:
    ...
    // TLM initiator socket for translated traffic (AXI4)
    tlm_utils::simple_initiator_socket<TLBAppIn0, 64> translated_socket;
...
public:
    ...
    // TLM initiator socket for translated traffic (AXI4)
    tlm_utils::simple_initiator_socket<TLBAppIn1, 64> translated_socket;
