...
// CHECKSUM:fcc4c1b59fa7d2ba32587531e04921ac35709ba4 
...
class Keranous_pcie_tileTestHarness : public scml2::testing::test_group<::keraunos::pcie::KeraunosPcieTile, Keranous_pcie_tileMirror, scml2::testing::fast_build_covergroup<Keranous_pcie_tileCovermodel > > {
  protected:
    ...
    sc_core::sc_signal< unsigned > noc_timeout_signal;
    scml2::testing::output_pin_proxy< unsigned > noc_timeout;
    sc_core::sc_signal< bool > pcie_cii_hv_signal;
    scml2::testing::input_pin_proxy< bool > pcie_cii_hv;
    sc_core::sc_signal< unsigned > pcie_cii_hdr_type_signal;
    scml2::testing::input_pin_proxy< unsigned > pcie_cii_hdr_type;
    sc_core::sc_signal< unsigned > pcie_cii_hdr_addr_signal;
    scml2::testing::input_pin_proxy< unsigned > pcie_cii_hdr_addr;
