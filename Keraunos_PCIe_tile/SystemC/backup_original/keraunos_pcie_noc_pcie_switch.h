...
public:
    ...
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_app_inbound_port0;  // TLB App0 (AxADDR[63:60] = 0)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_app_inbound_port1;  // TLB App1 (AxADDR[63:60] = 1)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_sys_inbound_port;   // TLB Sys0 (AxADDR[63:60] = 4)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> bypass_app_port;         // Bypass App (AxADDR[63:60] = 8)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> bypass_sys_port;         // Bypass Sys (AxADDR[63:60] = 9)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> pcie_controller_initiator;  // PCIe Controller (outbound - sending TO controller)
    
    // Initiator ports for outbound TLB connections (forward transactions to TLBs)
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_app_out0_initiator;        // To TLB App Out0 outbound_socket
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_app_out1_initiator;        // To TLB App Out1 outbound_socket
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> tlb_sys_out0_initiator;        // To TLB Sys Out0 outbound_socket
    
    // Initiator ports for switch interconnections
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> noc_io_initiator;               // To NOC-IO switch
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64> smn_io_initiator;               // To SMN-IO switch
...
protected:
    ...
    tlm_utils::simple_initiator_socket<NocPcieSwitch, 64>* get_initiator_port(NocPcieRoute route);
